...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/admin/vendors/datatables.net-bs/css/dataTables.bootstrap.min.css') }}">

    {{-- <link href="vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css" rel="stylesheet"> --}}
    <link rel="stylesheet" href="{{ asset('assets/admin/vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css') }}">

    <link rel="stylesheet" href="{{ asset('assets/admin/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/admin/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css') }}">
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            ...
            @else
                <h2>Guest</h2> <!-- Or any other default value you want to display for non-authenticated users -->
            @endauth
                        </div>
            </div>
            <!-- /menu profile quick info -->
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-desktop"></i> Cars <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{ route('admin.addCar') }}">Add Car</a></li>
										<li><a href="{{ route('admin.cars') }}">Cars List</a></li>
									</ul>
								</li>
                <li><a><i class="fa fa-desktop"></i> Testimonials <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{ route('admin.addTestimonials') }}">Add Testimonials</a></li>
										<li><a href="{{ route('admin.testimonials') }}">Edit Testimonials</a></li>
									</ul>
								</li>
                ...
                <ul class=" navbar-right">
                  ...
                  <li role="presentation" class="nav-item dropdown open">
                    ...
                    <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                      ...
                      <li class="nav-item">
                          <!-- Message Item -->
                          <a class="dropdown-item" href="{{route('admin.showMessage',  $message->id)}}">
                              <!-- Profile Image -->
                              ...
                              <!-- Message Content -->
                              <span class="message">{{substr($message->message, 0, 20)}}...</span>
                          </a>
                      </li>
                      @endforeach
