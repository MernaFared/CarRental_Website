			...
			<div class="row">
				<div class="col-md-12 col-sm-12 ">
					<div class="x_panel">
						...
						<div class="x_content">
							<br />
							<form id="demo-form2"  action="{{ route('admin.updateUser', ['user' => $user]) }}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
								@csrf
								@method('PUT')
								<div class="item form-group">
									...
									<div class="col-md-6 col-sm-6 ">
										<input type="text" id="full_name" name="full_name" value="{{ $user->full_name }}" required="required" class="form-control ">
									</div>
								</div>
								<div class="item form-group">
