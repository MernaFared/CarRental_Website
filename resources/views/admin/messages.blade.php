                ...
                <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <td><a href="{{ route('admin.showMessage', ['id' => $message->id]) }}"> <img src="{{ asset('./assets/admin/images/edit.png') }}"
                        alt="Show">
                       </a>
                      </td>
                      <td><a href="{{ route('admin.deleteMessage', ['id' => $message->id]) }}"> <img src="{{ asset('./assets/admin/images/delete.png') }}"
                        alt="Delete">
                      </a>
                    </td>
                    </tr>
