                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      @if( $testimonial->published === 1)
                        ...
                        <td><a href="{{ route('admin.editTestimonials', ['id' => $testimonial->id]) }}"> <img src="{{ asset('./assets/admin/images/edit.png') }}"
                          alt="Edit"></a>
                        </td>
                        <td><a href="{{ route('admin.deleteTestimonial', ['id' => $testimonial->id]) }}"> <img src="{{ asset('./assets/admin/images/delete.png') }}"
                          alt="Delete"></a>
                      </td>
